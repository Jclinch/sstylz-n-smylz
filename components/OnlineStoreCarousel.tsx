    ...
    <section className="relative py-20 px-6 bg-[#4b0039] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          {/* Cards */}
          <div className="grid grid-cols-2 md:flex md:flex-nowrap justify-center gap-4 sm:gap-6 transition-all duration-500 ease-in-out">
            {getVisibleProducts().map((product) => (
              <div
                key={product.id}
                className="w-full bg-white text-gray-900 rounded-3xl shadow-lg flex flex-col md:flex-row p-4 md:p-8"
              >

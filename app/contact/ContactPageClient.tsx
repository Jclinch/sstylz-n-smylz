...
export default function ContactPageClient() {
 ...
 return (
  <div className="relative z-10">
    ...
    <div
      ref={glowRef}
      className="fixed top-0 left-0 w-full h-full z-[95] pointer-events-none transition-all duration-300 ease-out"
    />

    {/* === Pulsing Gradient BG === */}
    <div className="fixed top-0 left-0 w-full h-full z-20 animate-gradientPulse bg-gradient-to-r from-purple-600 via-pink-500 to-yellow-400 opacity-30 blur-3xl pointer-events-none" />

    {/* === PAGE CONTENT starts here === */}
    <div className="relative z-10">
      {/* Everything from motion.div (Hero) down to the bottom */}

      <motion.div
  initial="hidden"
  animate="visible"
  variants={fadeInUp}
  className="relative h-[80vh] w-full overflow-hidden mt-[-120px] z-[120]" // ⬅️ Brought this forward
>
  <Image
    src="/images/contact-hero.png"
    alt="Contact Hero Background"
    fill
    sizes="100vw"
    className="object-cover z-[120]" // ⬅️ Brought image to front
    priority
  />
